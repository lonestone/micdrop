...
The Node.js server implementation of [Micdrop](../guides/readme).

For browser implementation, see [@micdrop/client](../client/overview) package.
...
- **[Agent](./agent)** - Abstract class for answer generation
- **[STT](./stt)** - Abstract class for speech-to-text
- **[TTS](./tts)** - Abstract class for text-to-speech
...
Check out the demo implementation in the [demo-server](../guides/demo-server) package. It shows:
...
Learn more about the protocol of Micdrop in [protocol](./protocol).
