...
Devices are listed and changed with the methods of [Device management](/docs/client/devices-management), `micDevices`, `speakerDevices`, `changeMicDevice` and `changeSpeakerDevice`. What a phone changes is what those lists hold.
