...
description: 'Let the user pause mid-sentence and keep the floor, either by reading the sound of their voice with a small model or by asking the agent to weigh the transcript.'
order: 39
---
