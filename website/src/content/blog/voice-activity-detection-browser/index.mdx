...
On a phone, `@micdrop/react-native` runs the volume detector by default, with Silero available as an extra native module. You also choose there where transcription happens, a decision [Speech to text in React Native](/blog/speech-to-text-react-native) compares route by route.
